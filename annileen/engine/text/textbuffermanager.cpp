/*
* Mostly copied from text_buffer_manager in bgfx examples
*/
...
#include <engine/text/atlas.h>

#include <engine/text/vs_font_basic.bin.h>
#include <engine/text/fs_font_basic.bin.h>
#include <engine/text/vs_font_distance_field.bin.h>
#include <engine/text/fs_font_distance_field.bin.h>
#include <engine/text/vs_font_distance_field_subpixel.bin.h>
#include <engine/text/fs_font_distance_field_subpixel.bin.h>
#include <engine/text/vs_font_distance_field_outline.bin.h>
#include <engine/text/fs_font_distance_field_outline.bin.h>
#include <engine/text/vs_font_distance_field_outline_image.bin.h>
#include <engine/text/fs_font_distance_field_outline_image.bin.h>
#include <engine/text/vs_font_distance_field_drop_shadow.bin.h>
#include <engine/text/fs_font_distance_field_drop_shadow.bin.h>
#include <engine/text/vs_font_distance_field_drop_shadow_image.bin.h>
#include <engine/text/fs_font_distance_field_drop_shadow_image.bin.h>
#include <engine/text/vs_font_distance_field_outline_drop_shadow_image.bin.h>
#include <engine/text/fs_font_distance_field_outline_drop_shadow_image.bin.h>
